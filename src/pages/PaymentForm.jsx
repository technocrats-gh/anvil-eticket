    ...
    const onSubmit = async (values) => {
        ...
        try {
            const response = await instance.post('/transaction/initialize', {
                ...
                currency: 'GHS',
                reference: values.transactionRef,
                                                    ...
                                                    <Formik initialValues={initialValues} onSubmit={onSubmit}>
                                                        {props => (<Form>
                                                            <div className="grid formgrid">
                                                                ...
                                                                <div className="col-12 lg:col-6 field mb-4">
                                                                    <Field id="transactionRef" name="transactionRef" placeholder="Transaction Reference" className="p-inputtext lg:w-full"
                                                                        style={{ borderColor: props.errors.transactionRef ? "red" : "" }} validate={validate} />
                                                                </div>
                                                                <div className="col-12 lg:col-6 field mb-4">
